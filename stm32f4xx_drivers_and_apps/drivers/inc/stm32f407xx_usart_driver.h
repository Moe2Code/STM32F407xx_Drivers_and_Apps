...
/*
 * This is a Configuration structure for the USARTx peripheral
 */
...
typedef struct
{
	...
	uint8_t USART_ParityControl;		/* possible values from @USART_PartiyControl     	*/
	uint8_t USART_HWFlowControl;		/* possible values from @USART_HWFlowControl		*/
}USART_Config_t;


/*
 * This is a Handle structure for the USART peripheral
 */

typedef struct
{
	USART_RegDef_t *pUSARTx;			/* To hold the base address of the USARTx peripheral  				*/
	USART_Config_t USART_Config;		/* To hold the USARTx peripheral configuration settings		  		*/
	uint8_t TxLen;
	uint8_t RxLen;
	uint8_t TxBusyState;
	uint8_t RxBusyState;
